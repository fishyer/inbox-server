...
This project is indexed by GitNexus as **inbox-server** (213 symbols, 41 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
